  ...
  grunt.initConfig({
    ...
    less: {
      development: {
        ...
        files: {
          "_build/css/style.css": "_working/less/style.less" // destination file and source file
        }
      }
    },
    copy: {
    ...
    watch: {
      styles: {
        files: ['_working/img/*', '_working/**/*.less', '_working/**/*.css', '_working/**/*.js', '_working/**/*.html'], // which files to watch
